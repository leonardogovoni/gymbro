<x-app-layout>
    ...
    {{-- <div class="relative w-[85%] mx-auto border p-4 bg-gray-100 dark:bg-gray-700 rounded mt-4">
        ...
        <div class="relative h-48 overflow-y-auto scroll-smooth border rounded bg-white dark:bg-gray-800">
            ...
            <a href="#exercise-1"
                class="absolute top-2 left-1/2 transform -translate-x-1/2 text-gray-500 hover:text-black">
                &#9650;
            </a>

            <a href="#exercise-last"
                class="absolute bottom-2 left-1/2 transform -translate-x-1/2 text-gray-500 hover:text-black">
                &#9660;
            </a>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-200 dark:bg-gray-700 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                    ...
                    @else
                        <p class="text-center text-3xl text-gray-900 dark:text-white mb-2"> {{ $workout_plan_title }}
                        </p>
