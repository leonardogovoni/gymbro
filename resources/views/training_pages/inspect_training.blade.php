							...
							@for ($i = 0; $i < $exercises[$currentIndex]->pivot->series; $i++)
								<tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
									...
									<td class="p-2 border border-gray-300 dark:border-gray-600">
										@if ($exercises[$currentIndex]->pivot->repetitions != "MAX")
											<input type="number" class="w-full p-1 rounded border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white" value="{{ $exercises[$currentIndex]->pivot->repetitions }}">
										@else
