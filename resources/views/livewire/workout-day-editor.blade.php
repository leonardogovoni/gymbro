<div>
    ...
    <ul 
        wire:sortable="updateOrder" wire:sortable.options="{ animation: 100 }"
        class="bg-gray-100 dark:bg-gray-800 p-4 divide-y divide-slate-200 rounded border shadow-sm" id="d{{ $day }}">
        ...
        <div class="pt-4 flex flex-col items-center">
            <x-primary-button class="bg-green-600 hover:bg-green-700" x-data="" x-on:click.prevent="$dispatch('open-modal', 'prova')">
                Aggiungi esercizio
            </x-danger-button>
        </div>
    </ul>
