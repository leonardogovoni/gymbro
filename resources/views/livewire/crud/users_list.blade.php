<div x-data="{showDelete: false, id: 0}">
	...
	<!-- Delete modal -->
	<div x-cloak x-show="showDelete" class="fixed inset-0 bg-black bg-opacity-30 z-50 backdrop-blur-sm bg-white/30 flex justify-center items-center">
