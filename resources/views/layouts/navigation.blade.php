<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b @if(isset($dashboard) && $dashboard) w-full fixed @endif">
		...
		<div class="flex justify-between h-16">
			<div class="flex">
				...
				@auth
					...
					<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
						<x-nav-link :href="route('statistics.list')" :active="request()->routeIs('statistics.list')">
							{{ __('Statistiche') }}
						</x-nav-link>
					</div>
	...
	<div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
		...
		<div class="pt-2 pb-3 space-y-1">
			<x-responsive-nav-link :href="route('statistics.list')" :active="request()->routeIs('statistics.list')">
				{{ __('Statistiche') }}
			</x-responsive-nav-link>
		</div>
